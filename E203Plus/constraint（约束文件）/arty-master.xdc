...
set_property -dict {PACKAGE_PIN C10 IOSTANDARD LVCMOS33} [get_ports sw_2]
set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS33} [get_ports sw_3]
...
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33 IOB TRUE} [get_ports qspi_cs]
set_property IOSTANDARD LVCMOS33 [get_ports {qspi_dq[0]}]
set_property IOB TRUE [get_ports {qspi_dq[0]}]
set_property PACKAGE_PIN K17 [get_ports {qspi_dq[0]}]
set_property PULLUP true [get_ports {qspi_dq[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {qspi_dq[1]}]
set_property IOB TRUE [get_ports {qspi_dq[1]}]
set_property PACKAGE_PIN K18 [get_ports {qspi_dq[1]}]
set_property PULLUP true [get_ports {qspi_dq[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {qspi_dq[2]}]
set_property IOB TRUE [get_ports {qspi_dq[2]}]
set_property PACKAGE_PIN L14 [get_ports {qspi_dq[2]}]
set_property PULLUP true [get_ports {qspi_dq[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {qspi_dq[3]}]
set_property IOB TRUE [get_ports {qspi_dq[3]}]
set_property PACKAGE_PIN M14 [get_ports {qspi_dq[3]}]
set_property PULLUP true [get_ports {qspi_dq[3]}]
...
create_clock -period 20.000 -name qspi_sck_pin -waveform {0.000 10.000} -add [get_ports qspi_sck]
