...

{
    ...
    {(uint8_t *)0x90008000,0x8000}, //内部 RAM，内存起始地址 0x200001C0 大小64KB

	{(uint8_t *)0xa0000000,0x100000},//外部SRAM，内存起始地址 0x68000000 大小1MB
...
const uint32_t ulValueToSend = 100UL;
    ...
    for( ;; )
    {
        ...
        Blocked state. */
         ...
         buffer = pvPortMalloc(32000);
         *buffer = 10;
         printf("malloc new addr: %u\n %d",buffer,*buffer);
         if(buffer!=NULL)
        	 vPortFree(buffer);
         buffer=NULL;
